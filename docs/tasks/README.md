...
| `task-055-paper-protocol-reproduction.md` | Review Ready | `docs/reproduction/PISA_BENCHMARK_CONTRACT.md`, `docs/prd/ROADMAP.md` | paper-protocol unit tests, local synthetic runner smoke test, figure export smoke test, and `bash scripts/verify.sh --strict-instance` |
| `task-056-monte-carlo-adam-compatibility.md` | Review Ready | `docs/prd/ROADMAP.md`, `docs/prd/09-decision-log.md` | 65 tests passed, ruff, mypy, wheel build, and `bash scripts/verify.sh --strict-instance` |
| `task-057-continuous-gaussian-model.md` | Review Ready | `docs/prd/01-mvp-scope.md`, `docs/prd/03-feature-design.md` | 68 tests passed, ruff, mypy, wheel build, and `bash scripts/verify.sh --strict-instance` |
